...
import myapp.models.Course;
import myapp.models.MarkSheet;
import myapp.models.Score;
import myapp.models.Student;
...
public class Home extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtDate.setFont(new java.awt.Font("Liberation Sans", 1, 15)); // NOI18N

        txtTime.setFont(new java.awt.Font("Liberation Sans", 1, 15)); // NOI18N
        ...
        jTextField17.setFont(new java.awt.Font("Liberation Sans", 1, 15)); // NOI18N
    ...
    private void jButton20ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton20ActionPerformed
        if (searchField2.getText().isEmpty()) {
            ...
            score.getScoreValue1(jTable3, searchField2.getText());
        }
            ...
            if (!(student.isIdExist(Integer.parseInt(jTextField1.getText())))) {
                if (!student.isEmailExist(jTextField3.getText())) {
                    if (!student.isPhoneExist(jTextField4.getText())) {
                        ...
                        String father = Standardize.name(jTextField5.getText());
                        String mother = Standardize.name(jTextField6.getText());
    ...
    private void jButton34ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton34ActionPerformed
        try {
            MessageFormat header = new MessageFormat("Mark sheet        Student's ID" + jTextField17.getText() + "      " + jLabel26.getText());
            MessageFormat footer = new MessageFormat("Page {0,number,integer}");
            jTable3.print(JTable.PrintMode.FIT_WIDTH, header, footer);
        } catch (PrinterException ex) {
            Logger.getLogger(Home.class.getName()).log(Level.SEVERE, null, ex);
